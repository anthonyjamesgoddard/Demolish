...
int main() {
    ...
    for (int i = 0; i < numberOfBodies; i++) {
        objz.push_back(demolish::Object(
            i, &meshs[i], locations[i], demolish::material::MaterialType::WOOD,
            false, true, true, 0.5, linear, angular));
    }
    ...
    objz.push_back(demolish::Object(numberOfBodies, &m, locationOfFloor,
                                    ...
                                    true, true, true, 0.5, linear, angular));
    angular = {0, 0, 0};
    meshTriangles.clear();
    meshVertices.clear();
    ...
    objz.push_back(demolish::Object(numberOfBodies + 1, &mc, locationOfCone,
                                    demolish::material::MaterialType::WOOD,
                                    true, true, true, 0.5, linear, angular));
    demolish::World aworld(objz, -0.98);
