...
namespace crashr {
namespace operators {
double computeXYZw(std::vector<double> xCoordinates,
                   std::vector<double> yCoordinates,
                   std::vector<double> zCoordinates);
double computeXZw(std::vector<double> xCoordinates,
                  std::vector<double> yCoordinates,
                  std::vector<double> zCoordinates);
...
crashr::Vertex computeBoundaryMinVertex(std::vector<double> xCoordinates,
                                        std::vector<double> yCoordinates,
                                        std::vector<double> zCoordinates);

crashr::Vertex computeBoundaryMaxVertex(std::vector<double> xCoordinates,
                                        std::vector<double> yCoordinates,
                                        std::vector<double> zCoordinates);

std::array<double, 6> computeBbox(std::vector<double> xCoordinates,
                                  std::vector<double> yCoordinates,
                                  std::vector<double> zCoordinates);
...
double computeDistanceAB(crashr::Vertex A, crashr::Vertex B);

double computeMin(std::vector<double> coordinates);

double computeMax(std::vector<double> coordinates);
